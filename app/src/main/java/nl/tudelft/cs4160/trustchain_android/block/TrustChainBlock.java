...
public class TrustChainBlock {
    ...
    public static MessageProto.TrustChainBlock createGenesisBlock(KeyPair kp) {
        MessageProto.TrustChainBlock block = MessageProto.TrustChainBlock.newBuilder()
                .setTransaction(ByteString.copyFromUtf8("This is the genesis block"))
     ...
     */
    public static MessageProto.TrustChainBlock builderHalfBlock(byte[] transaction, TrustChainDBHelper dbHelper,
                                                                byte[] mypubk,
                                                                byte[] linkpubk) {
        ...
        builder.setLinkPublicKey(ByteString.copyFrom(linkpubk));
        builder.setLinkSequenceNumber(TrustChainBlock.UNKNOWN_SEQ);
    ...
    public static MessageProto.TrustChainBlock builderFullBlock(TrustChainDBHelper dbHelper,
        ...
        builder.setSequenceNumber(linkedBlock.getSequenceNumber());
        builder.setPreviousHash(linkedBlock.getPreviousHash());
        builder.setPublicKey(linkedBlock.getPublicKey());
    ...
    public static String toShortString(MessageProto.TrustChainBlock block) {
        ...
        res += "\tPrevious Hash: " + bytesToHex(block.getPreviousHash().toByteArray()) + "\n";
        res += "\tSignature: " + bytesToHex(block.getSignature().toByteArray()) + "\n";
        res += "\tTransaction: \"" + block.getTransaction().toStringUtf8() + "\"\n";
